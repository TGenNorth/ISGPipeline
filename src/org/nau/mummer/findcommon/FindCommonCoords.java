 ...
 * @author jbeckstrom
 */
public class FindCommonCoords implements Runnable {

    private File coordsFile1, coordsFile2, intervalFile;
    private SAMSequenceDictionary seqDict;
    private boolean skipFirst;
    
    public FindCommonCoords(File coords1, File coords2, SAMSequenceDictionary seqDict, File intervalFile){
        this(coords1, coords2, seqDict, intervalFile, false);
    }
    
    public FindCommonCoords(File coords1, File coords2, SAMSequenceDictionary seqDict, File intervalFile, boolean skipFirst){
    ...
    public void run() {
        ...
        IntervalList intervalList = createIntervalList(seqDict);
